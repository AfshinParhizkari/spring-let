package com.afshin.redis.logger;
...
public class AopLogger {
    ...
    @Before("execution(* com.afshin.redis..service..*(..)) ")
    ...
    @Before("execution(* com.afshin.redis..controller..*(..)) ")
    ...
    @AfterThrowing(value = "execution(* com.afshin.redis..controller..*(..)) ", throwing = "e")
    ...
    @AfterReturning(value = "execution(* com.afshin.redis..controller..*(..)) ", returning = "returnValue")
