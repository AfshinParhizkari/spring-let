...
public class AopLogger {
    ...
    @Before("execution(* com.afshin..controller..*(..)) ")
    ...
    @AfterThrowing(value = "execution(* com.afshin..controller..*(..)) ", throwing = "e")
    ...
    @AfterReturning(value = "execution(* com.afshin..controller..*(..)) ", returning = "returnValue")
